...
# Object Files
OBJECTFILES= \
	${OBJECTDIR}/src/Wrappers/m_canbus.o \
...
${OBJECTDIR}/src/Wrappers/m_canbus.o: src/Wrappers/m_canbus.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Wrappers
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Wrappers/m_canbus.o src/Wrappers/m_canbus.cpp

${OBJECTDIR}/test/main.o: test/main.cpp
	${MKDIR} -p ${OBJECTDIR}/test
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/test/main.o test/main.cpp
